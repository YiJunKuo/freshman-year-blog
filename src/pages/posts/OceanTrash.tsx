            ...
            <div className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm">
              ...
              <ul className="list-disc list-inside text-slate-600 space-y-6">
                <li>
                  ...
                  <img src="https://yijunkuo.github.io/freshman-year-blog/images/oceantrash/home.jpg" alt="首頁" className="mt-2 rounded-lg w-full h-auto border border-slate-200" referrerPolicy="no-referrer" />
                </li>
                <li>
                  <strong>關於：</strong> 介紹計畫的初衷與團隊。
                  <img src="https://yijunkuo.github.io/freshman-year-blog/images/oceantrash/about.png" alt="關於" className="mt-2 rounded-lg w-full h-auto border border-slate-200" referrerPolicy="no-referrer" />
                </li>
                <li>
                  <strong>海廢從哪來：</strong> 追溯海洋廢棄物的源頭。
                  <img src="https://yijunkuo.github.io/freshman-year-blog/images/oceantrash/where.jpg" alt="海廢從哪來" className="mt-2 rounded-lg w-full h-auto border border-slate-200" referrerPolicy="no-referrer" />
                </li>
                <li>
                  <strong>海廢大挑戰：</strong> 透過互動遊戲讓使用者更了解海廢知識。
                  <img src="https://yijunkuo.github.io/freshman-year-blog/images/oceantrash/challenge.jpg" alt="海廢大挑戰" className="mt-2 rounded-lg w-full h-auto border border-slate-200" referrerPolicy="no-referrer" />
                </li>
                <li>
                  <strong>地圖：</strong> 標示出各地海廢的分佈情況。
                  <img src="https://yijunkuo.github.io/freshman-year-blog/images/oceantrash/map.png" alt="地圖" className="mt-2 rounded-lg w-full h-auto border border-slate-200" referrerPolicy="no-referrer" />
                </li>
              </ul>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm">
              ...
              <div className="rounded-xl overflow-hidden bg-slate-100">
                <video controls className="w-full">
                  <source src="https://yijunkuo.github.io/freshman-year-blog/images/oceantrash/rubberduck.mp4" type="video/mp4" />
