            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                  ...
                  <img src={`/images/BS2.jpg`} alt="紅豆" className="rounded-lg w-full h-auto" referrerPolicy="no-referrer" />
                </div>
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                  <h3 className="font-bold text-slate-900 mb-2">白水先生作品</h3>
                  <p className="text-sm text-slate-600 mb-4">綜合版面配置練習</p>
                  <img src={`/images/BS4.jpg`} alt="白水先生作品" className="rounded-lg w-full h-auto" referrerPolicy="no-referrer" />
                </div>
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                  <h3 className="font-bold text-slate-900 mb-2">送別</h3>
                  <p className="text-sm text-slate-600 mb-4">文字排版與色彩運用</p>
                  <img src={`/images/BS5.jpg`} alt="送別" className="rounded-lg w-full h-auto" referrerPolicy="no-referrer" />
                </div>
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                  <h3 className="font-bold text-slate-900 mb-2">迪士尼</h3>
                  <p className="text-sm text-slate-600 mb-4">網格系統與圖片應用</p>
                  <img src={`/images/disney.jpg`} alt="迪士尼" className="rounded-lg w-full h-auto" referrerPolicy="no-referrer" />
                </div>
              </div>
            </section>
          </div>
